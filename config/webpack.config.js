...
const WDLWorkspaceRoutesPlugin = require('./wdl-workspace-routes-plugin');

// Source maps are resource heavy and can cause out of memory issue for large source files.
// const shouldUseSourceMap = process.env.GENERATE_SOURCEMAP !== 'false';
// In our case, we DO have large source files, so:
...
module.exports = function (webpackEnv) {
  ...
  const getStyleLoaders = (
    ...
    const loaders = [
      ...
      // package.json
      !skipPostcss && {loader: require.resolve('postcss-loader')}
    ].filter(Boolean);
    if (preProcessor) {
      loaders.push({
  ...
  return {
    ...
    entry: [
      ...
      // require.resolve('./polyfills'), // todo
...

        {
          ...
          oneOf: [
            ...
            },
            {
              ...
              include: /(node_modules|src\/static-styles|src\\static-styles)/,
            ...
            },
            {
              ...
              exclude: /(node_modules|src\/static-styles|src\\static-styles)/,
              // Don't consider CSS imports dead code even if the
              // containing package claims to have no side effects.
              // Remove this when webpack adds a warning or an error for this.
              // See https://github.com/webpack/webpack/issues/6571
